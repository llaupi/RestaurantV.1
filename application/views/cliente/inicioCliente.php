...
<div class="container" id="imgProductosClientes">
	<div class="row">
      ...
      <p>{{p.precio}}</p>
        <input type="button" @click="headCliente.agregarCarritoCliente(p.codigo,p.nombre,p.precio,p.Descripcion)" value="agregar" id="btnCarro" class="btn-agregar btn  ">
      </div>
